                    ...
                    <div class="post-preview">
                        ...
                        <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1">
                            ...
                            <label for="sex">
                                Sex of Animal:</label>
                            <div class="form-group">
                                <div class="col-md-4 col-lg-2"><input type="radio" name="sex" value="male" checked="checked">
                                    M</div>
                                <div class="col-md-4 col-lg-2"><input type="radio" name="sex" value="female">
                                    F</div>
                                <div class="col-md-4 col-lg-4"><input type="radio" name="sex" value="unknown">
                                    Unknown</div><br>
                            </div>
                            <div class="form-group">
                                <input
                            ...
                            <div class="form-group">
                                <div class="col-md-4 col-lg-3"><input type="radio" name="health" value="good" checked="checked">
                                    Good</div>
                                <div class="col-md-4 col-lg-2"><input type="radio" name="health" value="bad">
                                    Bad</div>
                                <div class="col-md-4 col-lg-5"><input type="radio" name="health" value="unknown">
                                    Unknown</div><br>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-4 col-lg-4">
                                    <input type="radio" name="age" value="infant" checked="checked">
                                    Infant</div>
                                <div class="col-md-4 col-lg-4">
