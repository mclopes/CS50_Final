    ...
    <fieldset>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
             ...
             <label for="is_shelter">Are you a shelter?</label></div>
             <div class="col-lg-2  col-md-2 ">
            <input class="form-control" name="is_shelter" onclick="showMe('shelter')" type="checkbox" id="is_shelter" /></div>
        </div>
        <!--Shelter hidden div-->
        <br>
        <div id="shelter" style="display:none;">
            ...
            <label for="type"> Type of Shelter:</label>
            <div class="form-group"  >
                
                <div class="col-md-4 col-lg-4"> <input type="radio" name="type" value="dog" checked> Dog</div>
                <div class="col-md-4 col-lg-4"> <input class="col-md-4 col-lg-4" type="radio" name="type" value="cat"> Cat</div>
                <div class="col-md-4 col-lg-4"> <input class="col-md-4 col-lg-4" type="radio" name="type" value="mixed"> Mixed </div><br>
            </div>
